...
function getVersionInt(){
    let versionInt = 0;
    let versionParts = app.config.version.split(".");
    versionInt += parseInt(versionParts[2]);
    versionInt += 1000 * parseInt(versionParts[1]);
    versionInt += 1000000 * parseInt(versionParts[0]);
    return versionInt;
}